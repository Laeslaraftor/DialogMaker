...
![](DialogMaker/Preview/DialogMaker.png "Внешний вид программы")
...
## Использование
Проект разделён на 2 части: [редактор](/DialogMaker/) (WPF, .NET 10) и [ядро](/DialogMaker.Core/) (библиотека, .NET Standard 2.1).
