namespace DialogMaker.Core.Editor.Nodes
{
    public class DialogProjectStartNode : DialogProjectDialogNode
    {
        ...
        public DialogProjectStartNode(DialogProjectDialog dialog, DialogProjectDialogNodeSavedState savedState) : base(dialog, savedState)
        {
        }
        ...
        public DialogProjectNodeOutput Begin
        {
            get
            {
                field ??= new(this, nameof(Begin), DialogNodePortType.Action);
                return field;
            }
        }
