...
namespace DialogMaker.Core.Scripting.Compiler
{
    ...
    public static class DSharpCompilerExpressionExtensions
    {
        ...
        extension(IDSharpMemberInfo member)
        {
            ...
            /// <summary>
            /// Replace current member with provided replaced members
            /// </summary>
            /// <param name="assemblyBuilder">Assembly builder for replacing generic parameters</param>
            /// <param name="replacedMembers">Already replaced members</param>
            /// <returns>Replaced member</returns>
            public IDSharpMemberInfo Replace(DSharpAssemblyBuilder assemblyBuilder, IReadOnlyDictionary<IDSharpMemberInfo, IDSharpMemberInfo> replacedMembers)
            {
                ...
                while (declaringType != null)
                {
                    ...
                    var replacedType = assemblyBuilder.ReplaceGenericParameters(declaringType, replacedMembers);
                ...
                List<IDSharpType> ReplaceParameterTypes(IEnumerable<IDSharpParameterInfo> parameters)
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        var type = assemblyBuilder.ReplaceGenericParameters(parameter.Type, replacedMembers);
        ...
        extension(IdentifierExpressionNode identifierExpression)
        {
            ...
            /// </summary>
            /// <param name="context">Variable scope</param>
