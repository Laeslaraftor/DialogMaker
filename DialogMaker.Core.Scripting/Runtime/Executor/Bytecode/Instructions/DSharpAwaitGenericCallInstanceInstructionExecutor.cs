...
{
    /// <summary>
    /// Executor of <see cref="DSharpBytecodeOperation.AwaitGenericCallInstance"/> operation
    /// </summary>
    public class DSharpAwaitGenericCallInstanceInstructionExecutor : DSharpInstructionExecutor
    {
        #region Controls
        ...
        /// <summary>
        /// Global instance of <see cref="DSharpBytecodeOperation.AwaitGenericCallInstance"/> operation executor
        /// </summary>
        public static readonly DSharpAwaitGenericCallInstanceInstructionExecutor Instance = new();
