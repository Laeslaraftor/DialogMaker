...
{
    /// <summary>
    /// Executor of <see cref="DSharpBytecodeOperation.AwaitCallBaseInstance"/> operation
    /// </summary>
    public class DSharpAwaitCallBaseInstanceInstructionExecutor : DSharpInstructionExecutor
    {
        #region Controls
        ...
        /// <summary>
        /// Global instance of <see cref="DSharpBytecodeOperation.AwaitCallBaseInstance"/> operation executor
        /// </summary>
        public static readonly DSharpAwaitCallBaseInstanceInstructionExecutor Instance = new();
