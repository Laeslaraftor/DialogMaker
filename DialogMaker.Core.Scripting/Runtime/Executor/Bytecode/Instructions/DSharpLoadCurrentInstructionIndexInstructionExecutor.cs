...
{
    /// <summary>
    /// Executor of <see cref="DSharpBytecodeOperation.LoadCurrentInstructionIndex"/> operation
    /// </summary>
    public class DSharpLoadCurrentInstructionIndexInstructionExecutor : DSharpInstructionExecutor
    {
        #region Controls

        public override bool Execute(DSharpRuntimeInstruction instruction, ref DSharpExecutionContext context)
        {
            context.Stack.Push(context.InstructionIndex);
            return true;
        }
        ...
        /// <summary>
        /// Global instance of <see cref="DSharpBytecodeOperation.LoadCurrentInstructionIndex"/> operation executor
        /// </summary>
        public static readonly DSharpLoadCurrentInstructionIndexInstructionExecutor Instance = new();
