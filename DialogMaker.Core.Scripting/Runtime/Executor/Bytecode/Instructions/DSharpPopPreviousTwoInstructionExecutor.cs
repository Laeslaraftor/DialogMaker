...
{
    /// <summary>
    /// Executor of <see cref="DSharpBytecodeOperation.PopPreviousTwo"/> operation
    /// </summary>
    public class DSharpPopPreviousTwoInstructionExecutor : DSharpInstructionExecutor
    {
        #region Controls

        public override bool Execute(DSharpRuntimeInstruction instruction, ref DSharpExecutionContext context)
        {
            DSharpPopOffsetRepeatInstructionExecutor.Pop(1, 2, context);
            return true;
        }
        ...
        /// <summary>
        /// Global instance of <see cref="DSharpBytecodeOperation.PopPreviousTwo"/> operation executor
        /// </summary>
        public static readonly DSharpPopPreviousTwoInstructionExecutor Instance = new();
