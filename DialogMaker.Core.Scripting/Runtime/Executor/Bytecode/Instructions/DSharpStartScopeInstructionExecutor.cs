...
{
    /// <summary>
    /// Executor of <see cref="DSharpBytecodeOperation.StartScope"/> operation
    /// </summary>
    public class DSharpStartScopeInstructionExecutor : DSharpInstructionExecutor
    {
        #region Controls
        ...
        /// <summary>
        /// Global instance of <see cref="DSharpBytecodeOperation.StartScope"/> operation executor
        /// </summary>
        public static readonly DSharpStartScopeInstructionExecutor Instance = new();
