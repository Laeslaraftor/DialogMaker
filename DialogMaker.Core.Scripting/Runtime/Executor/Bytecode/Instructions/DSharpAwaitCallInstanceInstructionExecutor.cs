...
{
    /// <summary>
    /// Executor of <see cref="DSharpBytecodeOperation.AwaitCallInstance"/> operation
    /// </summary>
    public class DSharpAwaitCallInstanceInstructionExecutor : DSharpInstructionExecutor
    {
        #region Controls
        ...
        /// <summary>
        /// Global instance of <see cref="DSharpBytecodeOperation.AwaitCallInstance"/> operation executor
        /// </summary>
        public static readonly DSharpAwaitCallInstanceInstructionExecutor Instance = new();
