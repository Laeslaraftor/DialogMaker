...
{
    /// <summary>
    /// Executor of <see cref="DSharpBytecodeOperation.StopTrying"/> operation
    /// </summary>
    public class DSharpStopTryingInstructionExecutor : DSharpInstructionExecutor
    {
        #region Controls
        ...
        /// <summary>
        /// Global instance of <see cref="DSharpBytecodeOperation.StopTrying"/> operation executor
        /// </summary>
        public static readonly DSharpStopTryingInstructionExecutor Instance = new();
